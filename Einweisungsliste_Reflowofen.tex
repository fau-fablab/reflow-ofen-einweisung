...
\begin{itemize}
 \item die Regeln und Hinweise (Betriebsanweisung -- blaue Seite) kenne und mich daran halten werde
 \item die Einweisung (mehrere Seiten) gelesen und verstanden habe
 \item \textbf{den Reflowofen niemals unbeaufsichtigt betreiben werde}
 \item unter Anleitung erfolgreich eine Platine mit dem Reflowofen gelötet habe
\end{itemize}
